...
public class CurrencyCalculator
{
    ...
    public CurrencyCalculator(ICurrencyConverter converter, Bank bank, Logger logger, CurrencyValidator validator, CurrencyFormatter formatter)
    {
    ...
    public void Run()
    {
        ...
        Console.WriteLine("The available codes are: USD, JPY, EURO");
        Console.WriteLine("");
